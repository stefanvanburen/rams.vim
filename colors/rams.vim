...
" License:      MIT
" Last Updated: Tue Sep 15 15:55:30 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi DiffText guifg=#b8b8b8 guibg=#080808 gui=bold,reverse cterm=bold,reverse
  ...
  hi DiffChange guifg=#262b31 guibg=#ebebeb gui=reverse cterm=reverse
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi DiffText ctermfg=250 ctermbg=232 cterm=bold,reverse
  ...
  hi DiffChange ctermfg=235 ctermbg=255 cterm=reverse
  hi DiffDelete ctermfg=235 ctermbg=203 cterm=NONE
  hi DiffText ctermfg=235 ctermbg=255 cterm=bold
