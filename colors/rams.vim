...
" License:      MIT
" Last Updated: Wed May  5 10:37:03 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi LspDiagnosticsDefaultHint guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultInformation guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultWarning guifg=#ee483e guibg=NONE gui=NONE cterm=NONE
    hi LspDiagnosticsDefaultError guifg=#ee483e guibg=NONE gui=NONE cterm=NONE
    if !s:italics
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi! link LspReferenceText LspReference
    hi! link LspReferenceWrite LspReference
    hi LspDiagnosticsDefaultHint ctermfg=NONE ctermbg=NONE cterm=NONE
    hi LspDiagnosticsDefaultInformation ctermfg=NONE ctermbg=NONE cterm=NONE
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi LspDiagnosticsDefaultError ctermfg=NONE ctermbg=NONE cterm=NONE
    if !s:italics
      hi Folded cterm=NONE
      hi Comment cterm=NONE
    endif
